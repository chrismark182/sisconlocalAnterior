...
<div class="btn-small" id="btnBuscartra" onclick="BuscarTra(1,1,0)" >Buscar</div>
</div>

<div class="input-field col m1 right-align">
 	<a class="btn-small" onclick="MovimientoPersona(1,1,1)"   target="_blank"><i class="material-icons">file_download</i></a>
</div>


<!--<div class="input-field col m2 left-align right" style="margin: 0px; font-size: 12px;">-->
<div class="input-field col m3 left-align" style="font-size: 12px;">
Total Registros: <span id="totaltra" class="btn blue-grey darken-2">0</span>
</div>
...
<div class="btn-small" id="btnBuscartra" onclick="BuscarPro(1,2,0)" >Buscar</div>
</div>
			
 <div class="input-field col s2">
	 <a class="btn-small" onclick="MovimientoPersona(1,2,2)"  target="_blank"><i class="material-icons">file_download</i></a>
 </div>
