...
//INICIO
		...
		for(var i=0; i<len; i++){
			...
			table.append("<tr><td>"+ descrip_pago +"</td><td>" + monto_pago + "</td><td><a id='afilepago' href='" + ruta + "' target='_blank' class='btn btn-small'" + vdisabled  +"><i class='material-icons icon-white'>file_download</i></a>"	 + "</td><td></td></tr>");
		}
		     table.append("</tbody>");
		  },
			erro:function(){
...
//INICIO
		...
		for(var i=0; i<len; i++){
			...
			table.append("<tr><td>" + fechahisto + "</td><td>"+ descrip_pago +"</td><td>" + monto_pago + "</td><td><a id='afilepago' href='" + ruta + "' target='_blank' class='btn btn-small'" + vdisabled  +  "><i class='material-icons icon-white'>file_download</i></a>" + "</td><td></td></tr>");
		}
		     table.append("</tbody>");
		  },
			erro:function(){
